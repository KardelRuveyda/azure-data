...
İşlemsel sistemlerde (OLTP) her bir kalp atışını (siparişler, ödemeler) kaydettik. Peki, "Geçen yılın aynı dönemine göre satışlarımız neden düştü?" veya "En kârlı müşteri segmentimiz shangisi?" gibi soruların cevabını nerede bulacağız? 
